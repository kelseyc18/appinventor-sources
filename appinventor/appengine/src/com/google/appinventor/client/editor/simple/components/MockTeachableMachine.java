...
/**
 * Mock Teachable Machine component.
 */
public final class MockTeachableMachine extends MockVisibleComponent {

  /**
   * Component type name.
   */
  public static final String TYPE = "TeachableMachine";

  // Large icon image for use in designer.  Smaller version is in the palette.
  private final Image largeImage = new Image(images.teachablemachinebig());
   ...
   */
  public MockTeachableMachine(SimpleEditor editor) {
    super(editor, TYPE, images.teachablemachine());
  ...
  public MockTeachableMachine(SimpleEditor editor, String type) {
    super(editor, type, images.teachablemachine());
